...
import SubteamArtwork from "@/components/subteam-artwork"
...
export default function SubteamCard({ id, title, description, details }: SubteamCardProps) {
