  ...
  return (
    <Section title="About Us" label="WHO WE ARE" anchor="about">
      <div className="grid gap-10 lg:grid-cols-[1.45fr_0.55fr] lg:items-start">
        ...
        <div className="grid grid-cols-2 gap-px overflow-hidden border border-white/10 bg-white/10 lg:grid-cols-1">
          {stats.map((stat) => (
      ...
      <div className="grid gap-6 pt-12 md:grid-cols-2">
        ...
        <div className="industrial-card relative overflow-hidden border border-white/10 p-8 transition duration-300 hover:-translate-y-1 hover:border-primary/70">
          ...
          <p className="leading-relaxed text-white/75">
            We believe interested students should have meaningful opportunities to get involved in motorsports. We foster a collaborative environment where members can develop practical skills, learn from one another, and contribute to the team&#39;s success.
          </p>
        </div>
      </div>
    </Section>
